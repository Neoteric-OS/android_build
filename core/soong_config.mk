...
$(call add_json_map, PartitionVarsForSoongMigrationOnlyDoNotUse)
  ...
  $(call add_json_list, SystemKernelModules2ndStage16kbMode, $(foreach k,$(BOARD_SYSTEM_KERNEL_MODULES_2ND_STAGE_16KB_MODE),$(SYSTEM_KERNEL_DIR_16K)/$(k)))
  ...
  $(call add_json_list, VendorKernelModules2ndStage16kbMode, $(BOARD_VENDOR_KERNEL_MODULES_2ND_STAGE_16KB_MODE))
