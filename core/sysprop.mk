...
$(gen_from_buildinfo_sh): $(INTERNAL_BUILD_ID_MAKEFILE) $(API_FINGERPRINT) | $(BUILD_DATETIME_FILE) $(BUILD_NUMBER_FILE)
	$(hide) TARGET_BUILD_TYPE="$(TARGET_BUILD_VARIANT)" \
	        ...
	        Neoteric_DEVICE="$(TARGET_DEVICE)" \
	        Neoteric_DISPLAY_VERSION="$(AOSPA_DISPLAY_VERSION)" \
	        Neoteric_MAJOR_VERSION="$(AOSPA_MAJOR_VERSION)" \
	        Neoteric_MINOR_VERSION="$(AOSPA_MINOR_VERSION)" \
	        Neoteric_BUILD_VARIANT="$(AOSPA_BUILD_VARIANT)" \
